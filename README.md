...
- **GPU-Accelerated Animations** — `will-change` and `transform` ensure smooth 60fps effects
...
- Found a bug or broken game? **[Open a GitHub Issue](https://github.com/Avuix/avuix/issues)**
